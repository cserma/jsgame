class Sprite {
    ...
    animateFrames() {
        ...
        if (this.framesElapsed % this.framesHold === 0) {
            this.frameCurrent = this.frameCurrent < this.frameMax-1 ? this.frameCurrent+1 : 0
        }
    }
    update() {
        this.draw()
...
class Fighter extends Sprite{
    ...
    update() {
        ...
        if (this.position.y + this.height >= canvas.height - 63){
            this.velocity.y = 0
            this.position.y = canvas.height - this.height - 63
    ...
    switchSprite(sprite) {
        ...
        if (this.image === this.sprites.hit.image && this.frameCurrent < this.sprites.hit.frameMax -1) return
        switch (sprite) {
            case 'idle':
